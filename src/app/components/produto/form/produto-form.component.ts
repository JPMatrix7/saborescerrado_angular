...
export class ProdutoFormComponent implements OnInit {
  ...
  loadSabores(): void {
    this.saborService.findAll().subscribe({
      ...
      error: (error) => console.error('Erro ao carregar sabores:', error)
    });
  }
  ...
  loadEmbalagens(): void {
    this.embalagemService.findAll().subscribe({
      ...
      error: (error) => console.error('Erro ao carregar embalagens:', error)
    });
  }
  ...
  loadProduto(id: number): void {
    this.produtoService.findById(id).subscribe({
      ...
      error: (error) => console.error('Erro ao carregar produto:', error)
    });
  }
